Feature: As a user, I would like to have a page where I can open a support ticket and see the status of the tickets I have opened in order to solve the problems
  ...
  Scenario: TC_2302 Verify that the All Submitted Ticket List is visible on the Support Ticket page.
    * Go to the website
    * Login to the site as a user
    * Click on the dashboard button and then click on the support ticket button
  ...
  Scenario: TC_2303 In the All Submitted Ticket List, it should be verified that
  ...
  Scenario: TC_2304 When the View button is clicked on the Action column in the All Submitted Ticket List,
  ...
  Scenario: TC_2305 On the show page where the ticket information is displayed,
  ...
  Scenario: TC_2306 It should be verified that the response returned
  ...
  Scenario: TC_2307 It should be verified that the ticket
  ...
  Scenario: TC_2308 It should be verified that the Tickets shown in the All Submitted Ticket List are can be
  ...
  Scenario: TC_2309 It should be verified that the Create new ticket page is accessed with the Add New button.
    * Go to the website
    * Login to the site as a user
    * Click on the dashboard button and then click on the support ticket button
  ...
  Scenario Outline: TC_2310 By entering Subject, Category, Priority and Description,
